...
namespace Server.Models
{
    internal class RealHouse
    {
        ...
        public RealHouse()
        {
            ...
            {
                this.Rooms.Add(new RealRoom(roomName, 24.0, RoomDefaults.defaultLightState, RoomDefaults.defaultDesiredTemperature, 5.0));
            }
            this.Rooms.Add(new RealBathroom("Bathroom", 24.0, RoomDefaults.defaultLightState, 70.0, RoomDefaults.defaultDesiredTemperature, 5.0, BathroomDefaults.defaultDesiredHumidity, 5.0));
        }
